...
2. <https://github.com/tldr-pages/tldr> (tldr - 简化的命令手册, 59k+ stars)
3. [tree](http://mama.indstate.edu/users/ice/tree/) (tree - 目录树显示工具)
4. <https://github.com/Canop/broot> (broot - 现代目录导航工具, 12k+ stars)
